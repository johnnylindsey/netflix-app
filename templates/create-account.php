...
<body style="background-color: rgb(28, 148, 148);" style="color: white;">
<nav class="navbar navbar-dark bg-dark" >
    ...
    <div class="container" style="margin-top: 15px;">
        <div class="row col-xs-8">
            <h1 style="color: white;" class="text-center">CS4750 Netflix App</h1>
            <p style="color: white;" class="text-center">Please enter your new account information below.</p>
        </div>
